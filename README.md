...
This repository contains the first stage of an embedded AI project for robot manipulation. In this step we define manipulation tasks, generate trajectories on a real xArm 6 robot, and record the data in a clean format suitable for demonstration learning.
